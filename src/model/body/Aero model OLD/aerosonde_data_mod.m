% Modelo aerosonde modificado para que se parezca al DroneBoX

function aerosonde=aerosonde_data_mod
...
% Sideslip derivative
aerosonde.CYbeta = -0.284;
% Roll control derivative
aerosonde.CYda = 0;
% Yaw control derivative
aerosonde.CYdr = 0.45;
% Roll rate derivative
aerosonde.CYp = -0.0991;
% Yaw rate derivative
aerosonde.CYr = 0.5219;

%%% Pitch moment coefficient %%%
% Zero-alpha pitch
aerosonde.Cm0 = 0.3603;
% alpha derivative
aerosonde.Cmalpha = 0.0137;
%Cma = Cmalpha;
% Lift control derivative
aerosonde.Cmdf = 0;
% Pitch control derivative
aerosonde.Cmde = -3.10; % Este signo es la unica potencia de mando que cambia de signo!!
...
% Sideslip derivative
aerosonde.Clbeta = -0.0286;
% Roll control derivative
aerosonde.Clda = -0.6020;
% Yaw control derivative
aerosonde.Cldr = 0.0024;
% Roll rate derivative
aerosonde.Clp = -0.8333;
% Yaw rate derivative
aerosonde.Clr =  0.0347;

%%% Yaw moment coefficient %%%
% Sideslip derivative
aerosonde.Cnbeta = 0.3451;
% Roll control derivative
aerosonde.Cnda = -0.0401;
% Yaw control derivative
aerosonde.Cndr = -0.3620;
% Roll rate derivative
aerosonde.Cnp = -0.0066;
% Yaw rate derivative
aerosonde.Cnr = -0.1827;
