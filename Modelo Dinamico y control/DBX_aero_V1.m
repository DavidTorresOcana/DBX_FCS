%% Import the data
[~, ~, raw0_0] = xlsread('C:\Users\David\Documents\Estudios y formación academica\Proyectos\xxcopter\DroneBoX\Modelo Dinamico y control\Datos Aero DBX v1.xlsx','Datos RAW','A2:E52');
[~, ~, raw0_1] = xlsread('C:\Users\David\Documents\Estudios y formación academica\Proyectos\xxcopter\DroneBoX\Modelo Dinamico y control\Datos Aero DBX v1.xlsx','Datos RAW','AA2:AF52');
raw = [raw0_0,raw0_1];
